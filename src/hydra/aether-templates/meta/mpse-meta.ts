...
export const mpseMetaTemplate: AuditorTemplate = {
  layerId: 'mpse-meta',
  ...
  graphQueries: [
    'show all nodes and edges from the merged graph with MPSE tags',
    'find tag clusters where same file:line has multiple MPSE predicate hits',
    'show god nodes and community anomalies in the MPSE-tagged graph',
  ],
  filterTags: ['mpse-meta', 'orchestrator', 'stitch', 'meta-review'],
};
