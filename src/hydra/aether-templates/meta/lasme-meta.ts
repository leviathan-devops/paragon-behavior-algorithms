...
export const lasmeMetaTemplate: AuditorTemplate = {
  layerId: 'lasme-meta',
  ...
  graphQueries: [
    ...
    'find god nodes and their concentrations',
    'show community anomalies and tag clusters',
  ],
  filterTags: ['lasme-meta', 'orchestrator', 'stitch', 'meta-review'],
};
