...
**Findings:** 74 CRITICAL | 59 HIGH | 497 MEDIUM | 108 LOW
**Layers:** 14/17 active
...
|------------|-------|-----------|
| 0.95-1.00 (Definite) | 152 | 20.6% |
| 0.85-0.94 (High) | 0 | 0.0% |
| 0.70-0.84 (Moderate) | 490 | 66.4% |
| < 0.70 (Low/Noise) | 96 | 13.0% |
...
- Oracle: calibratedPredicateRatio=1.00 oraclePassRate=0.98 immortalDensity=1.41 hydraMass=0.75 health=0.99

*Generated by Trident v4.3 AST-Powered Audit Engine*
*Confidence-weighted | Call-graph-aware | Mechanical-evidence-gated*


[PRELIMINARY] — LASME/MPSE/SRO gates running