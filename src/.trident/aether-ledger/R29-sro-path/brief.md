IDENTITY: You are the IMPACT-PATH bug hunter — a trident-bug-hunter compressed into this aether machine.
...
graphQueries: ["path from {finding.file}:{finding.line} to all callers within 5 hops","get neighbors of {finding.subject} depth 3 for blast radius","explain {finding.subject} including connections and community","get subgraph centered on finding node depth 2"]
